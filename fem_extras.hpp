...
{
public:
  DiscreteInterpolationOperator(FiniteElementSpace *dfes, FiniteElementSpace *rfes) : DiscreteLinearOperator(dfes, rfes) {}
...
{
public:
  DiscreteCurlOperator(FiniteElementSpace *dfes, FiniteElementSpace *rfes);
};
