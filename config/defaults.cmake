...
option(MFEM_USE_ZLIB "Enable zlib for compressed data streams." ON)
option(MFEM_USE_LIBUNWIND "Enable backtrace for errors." OFF)
option(MFEM_USE_LAPACK "Enable LAPACK usage" OFF)
option(MFEM_THREAD_SAFE "Enable thread safety" ON)
option(MFEM_USE_OPENMP "Enable the OpenMP backend" ON)
option(MFEM_USE_LEGACY_OPENMP "Enable legacy OpenMP usage" ON)
...
set(NETCDF_DIR "$ENV{HOME}/EMoffice" CACHE PATH "Path to the NetCDF library.")
set(NetCDF_REQUIRED_PACKAGES "HDF5/C/HL" CACHE STRING
    "Additional packages required by NetCDF.")

message(STATUS "Additional Lib/Include Path: $ENV{HOME}/EMoffice")
